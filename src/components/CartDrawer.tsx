  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative border-border/50 hover:border-primary/50 bg-transparent">
                    ...
                    <div key={item.variantId} className="flex gap-4 p-3 bg-secondary/30 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-primary">
                          {currencyCode === 'INR' ? '₹' : currencyCode} {parseFloat(item.price.amount).toFixed(2)}
                        </p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border bg-card">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-gradient-gold">
                    {currencyCode === 'INR' ? '₹' : currencyCode} {totalPrice.toFixed(2)}
                  </span>
                </div>
