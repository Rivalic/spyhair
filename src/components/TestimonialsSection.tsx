...
const testimonials = [
  ...
  },
  {
    ...
    location: "Delhi",
    rating: 5,
    text: "Best investment I've ever made. The quality is outstanding and the customer service is top-notch. Highly recommend HairLayer!",
  },
  {
    id: 3,
    name: "Vikram Patel",
    location: "Bangalore",
    rating: 5,
    text: "I was skeptical at first, but HairLayer exceeded all my expectations. Comfortable, natural-looking, and easy to maintain.",
  },
  {
    id: 4,
    name: "Arjun Mehta",
    location: "Pune",
    rating: 5,
    text: "The transformation is amazing! I look 10 years younger. The team at HairLayer is professional and caring.",
  },
  {
    id: 5,
    name: "Karan Singh",
    location: "Hyderabad",
    rating: 5,
    text: "Undetectable and comfortable. I can swim, exercise, and live my life without any worries. Thank you HairLayer!",
  },
  {
    id: 6,
    name: "Rohit Desai",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Join thousands of satisfied customers who have transformed their lives with HairLayer
          </p>
        </motion.div>
